...
const sleep$1 = (n2 = 500) => new Promise((r2) => setTimeout(r2, n2));
...
function Todos() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Todos+2" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: data.map(
      (item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: item.caption }, `${item.caption}-${i}`)
    ) })
  ] });
}
const routes = [
  {
    ...
    children: [
      ...
      {
        path: "lazy",
        lazy: () => __vitePreload(() => import("./lazy-COSVeF_8.js"), true ? [] : void 0)
      },
      {
        path: "redirect",
      ...
      },
      {
        path: "todos",
        loader: todosLoader,
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(Todos, {})
      },
      {
        path: "*",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(NoMatch, {})
      }
    ]
  }
];
function Layout() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Data Router Server Rendering Example" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "If you check out the HTML source of this page, you'll notice that it already contains the HTML markup of the app that was sent from the server, and all the loader data was pre-fetched!" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "This is great for search engines that need to index this page. It's also great for users because server-rendered pages tend to load more quickly on mobile devices and over slow networks." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Another thing to notice is that when you click one of the links below and navigate to a different URL, then hit the refresh button on your browser, the server is able to generate the HTML markup for that page as well because you're using React Router on the server. This creates a seamless experience both for your users navigating around your site and for developers on your team who get to use the same routing library in both places." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/lazy", children: "Lazy" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/redirect", children: "Redirect to Home" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/todos", children: "Todo list" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/nothing-here", children: "Nothing Here" }) })
    ] }) }),
...
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "About" }) });
}
...
function NoMatch() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Nothing to see here!" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", children: "Go to the home page" }) })
  ] });
}
hydrate();
async function hydrate() {
  var _a;
  let lazyMatches = (_a = matchRoutes(routes, window.location)) == null ? void 0 : _a.filter(
    (m2) => m2.route.lazy
  );
  if (lazyMatches && (lazyMatches == null ? void 0 : lazyMatches.length) > 0) {
    await Promise.all(
      lazyMatches.map(async (m2) => {
        let routeModule = await m2.route.lazy();
  ...
  client.hydrateRoot(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(RouterProvider, { router, fallbackElement: null }) })
  );
}
export {
